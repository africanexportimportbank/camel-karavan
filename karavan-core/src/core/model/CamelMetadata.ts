...
export const CamelDataFormatMetadata: ElementMeta[] = [
    ...
    new ElementMeta('ocsf', 'OcsfDataFormat', 'OCSF', "Marshal and unmarshal OCSF (Open Cybersecurity Schema Framework) security events to/from JSON.", 'dataformat,transformation,json,security', [
        ...
        new PropertyMeta('collectionType', 'Collection Type', "Refers to a custom collection type to lookup in the registry to use. This option should rarely be used, but allows to use different collection types than java.util.Collection based as default.", 'string', '', '', false, false, false, false, 'advanced', ''),
        new PropertyMeta('useList', 'Use List', "To unmarshal to a List of OCSF events.", 'boolean', '', 'false', false, false, false, false, '', ''),
        new PropertyMeta('allowUnmarshallType', 'Allow Unmarshall Type', "If enabled then the unmarshal type can be specified via the CamelOcsfUnmarshalType header. This should only be enabled when desired to be used.", 'boolean', '', 'false', false, false, false, false, '', ''),
        new PropertyMeta('prettyPrint', 'Pretty Print', "To enable pretty printing output nicely formatted. Is by default false.", 'boolean', '', 'false', false, false, false, false, '', ''),
    ], [
    ]),
    ...
    new ElementMeta('pqc', 'PQCDataFormat', 'PQC (Post-Quantum Cryptography)', "Encrypt and decrypt messages using Post-Quantum Cryptography Key Encapsulation Mechanisms (KEM).", 'dataformat,transformation,security', [
        new PropertyMeta('id', 'Id', "The id of this node", 'string', '', '', false, false, false, false, '', ''),
        new PropertyMeta('keyEncapsulationAlgorithm', 'Key Encapsulation Algorithm', "The Post-Quantum KEM algorithm to use for key encapsulation. Supported values: MLKEM, BIKE, HQC, CMCE, SABER, FRODO, NTRU, NTRULPRime, SNTRUPrime, KYBER", 'string', 'MLKEM, BIKE, HQC, CMCE, SABER, FRODO, NTRU, NTRULPRime, SNTRUPrime, KYBER', 'MLKEM', false, false, false, false, '', ''),
        new PropertyMeta('symmetricKeyAlgorithm', 'Symmetric Key Algorithm', "The symmetric encryption algorithm to use with the shared secret. Supported values: AES, ARIA, RC2, RC5, CAMELLIA, CAST5, CAST6, CHACHA7539, etc.", 'string', 'AES, ARIA, RC2, RC5, CAMELLIA, CAST5, CAST6, CHACHA7539, DSTU7624, GOST28147, GOST3412_2015, GRAIN128, HC128, HC256, SALSA20, SEED, SM4, DESEDE', 'AES', false, false, false, false, '', ''),
        ...
        new PropertyMeta('keyPair', 'Key Pair', "Refers to the KeyPair to lookup from the register to use for KEM operations.", 'string', '', '', false, false, false, false, '', ''),
        new PropertyMeta('bufferSize', 'Buffer Size', "The size of the buffer used for streaming encryption/decryption.", 'number', '', '4096', false, false, false, false, 'advanced', ''),
        new PropertyMeta('provider', 'Provider', "The JCE security provider to use.", 'string', '', '', false, false, false, false, 'advanced', ''),
        new PropertyMeta('keyGenerator', 'Key Generator', "Refers to a custom KeyGenerator to lookup from the register for KEM operations.", 'string', '', '', false, false, false, false, 'advanced', ''),
    ], [
    ]),
